...
-- When enabled, unlocks developer sub-options (e.g. show all orchestration events)
...
-- Recreate update_settings with new p_developer_mode param
DROP FUNCTION IF EXISTS update_settings(boolean, text, text, boolean);
