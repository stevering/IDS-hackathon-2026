 ...
 *
 * Format: `YYYY-MM-DDTHH:mm:ss.sssZ [tag] k=v k=v | message`
 *
 * Grep-friendly:
 ...
 *
 * SaaS-friendly: every line starts with ISO timestamp, key=value pairs
 * are trivially parseable by Datadog, Loki, CloudWatch Insights, etc.
 */
 ...
 *
 * @param tag  - Short tag for the subsystem, e.g. "figma-exec", "orch/start"
 * @param ctx  - Base context key=value pairs included in every log line
 */
