/**
 * Guardian SVG mascot — inline, with CSS animation hooks.
 * Based on assets/Shield_v2.svg (the "G" character with a face).
 */
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="100%" height="100%" aria-hidden="true">
  ...
  <!-- Eyebrows (attentive / listening expression) -->
  ...
  <!-- Left eye: iris + reflections (animated as a group for realistic blink) -->
  <g class="eye-left">
